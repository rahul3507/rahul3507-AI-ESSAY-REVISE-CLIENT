...
const QuickActionsCard = () => {
  return (
    <div className="max-w-4xl w-full mx-auto bg-white rounded-xl shadow-md p-4 sm:p-6 md:p-8 border border-base-300">
      {/* Header */}
      ...
      <Link
        to="/upload_one"
        className="w-full flex items-center justify-center gap-2 bg-[#1E2839] cursor-pointer text-white font-medium py-2.5 rounded-md mb-6 transition"
      >
